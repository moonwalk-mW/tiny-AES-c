...
static int test_cbc_CS(void);
static int test_ecb_CS(void);
...
static int test_cbc_CS(void)
{
    ...
    memcpy(out,in,TESTBYTES); //save off original
    ...
    for (i = (uint8_t) 0; i < (uint8_t) 4; ++i)
    {
        phex(out + i * (uint8_t) 16);
    }
    printf("\n");
    */
    AES_CBC_CS1_encrypt_buffer(&ctx, in, TESTBYTES);
    ...
    */
    AES_init_ctx_iv(&ctx, key, iv); //re-init
    AES_CBC_CS1_decrypt_buffer(&ctx, in, TESTBYTES);
    ...
    */
    ...
    uint8_t retVal = 0;
    if (0 == memcmp((char*) out, (char*) in, TESTBYTES)) {
        printf("SUCCESS!\n");
	      retVal += 0;
    } else {
        printf("FAILURE!\n");
    ...
    printf("\n");
    */
    AES_CBC_CS2_encrypt_buffer(&ctx, in, TESTBYTES);
    ...
    */
    AES_init_ctx_iv(&ctx, key, iv); //re-init
    AES_CBC_CS2_decrypt_buffer(&ctx, in, TESTBYTES);
    ...
    printf("\n");
    */
    AES_CBC_CS3_encrypt_buffer(&ctx, in, TESTBYTES);
    ...
    */
    AES_init_ctx_iv(&ctx, key, iv); //re-init
    AES_CBC_CS3_decrypt_buffer(&ctx, in, TESTBYTES);
...
static int test_ecb_CS(void)
{
    ...
    printf("\n");
    */
    AES_ECB_CS1_encrypt_buffer(&ctx, in, TESTBYTES);
    ...
    printf("\n");
    */
    AES_init_ctx(&ctx, key); //re-init
    AES_ECB_CS1_decrypt_buffer(&ctx, in, TESTBYTES);
    ...
    */
    ...
    printf("\n");
    */
    AES_ECB_CS2_encrypt_buffer(&ctx, in, TESTBYTES);
    ...
    */
    AES_init_ctx(&ctx, key); //re-init
    AES_ECB_CS2_decrypt_buffer(&ctx, in, TESTBYTES);
    ...
    printf("\n");
    */
    AES_ECB_CS3_encrypt_buffer(&ctx, in, TESTBYTES);
    ...
    */
    AES_init_ctx(&ctx, key); //re-init
    AES_ECB_CS3_decrypt_buffer(&ctx, in, TESTBYTES);
